...
def move_to_hand(hand_landmarks, robot_pos):
    if hand_landmarks:
        ...
        if(hand_size > MAX_HAND_SIZE):
            ...
            screen_z = (hand_size - MIN_HAND_SIZE) / (MAX_HAND_SIZE - MIN_HAND_SIZE) * video_resolution[0] - (video_resolution[0]/2)
